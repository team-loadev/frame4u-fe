    ...
    <div className="flex gap-13">
      ...
      <div className="flex flex-col gap-7">
        ...
        <div className="flex gap-3">
          <Button onClick={() => console.log('')} backgroundColor={colors.gray[100]} color={colors.gray[900]} borderColor={colors.gray[300]} hoverBackgroundColor={colors.gray[200]}>Download</Button>
