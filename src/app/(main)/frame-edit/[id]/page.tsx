  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="w-full flex justify-between flex-wrap gap-2 ">
        <Text fontSize={24} fontWeight={700}>Edit a Frame</Text>
        <div className="flex gap-4">
          <Button onClick={() => router.back() }>Back</Button>
          <Button onClick={() => router.push('/')} backgroundColor={colors.gray[100]} color={colors.gray[900]} hoverBackgroundColor={colors.gray[200]}>Edit</Button>
        </div>
      </div>
